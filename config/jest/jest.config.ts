...
export default {
    ...
    // cacheDirectory: "C:\\Users\\AMaklachkov\\AppData\\Local\\Temp\\jest",
    ...
    // Подключаем отчеты о прохождении тестов
    reporters: [
        'default',
        [
            'jest-html-reporters',
            {
                ...
                openReport: true,
                // не будут гененрироваться отдельные js-файлы отчета
                // Весь код будет в report.html без доп файлов
                inlineSource: true,
            },
        ],
    ],
