...
module.exports = async (layer, sliceName) => {
    ...
    // Наполняем кодом слай Redux
    const createReduxSlice = async () => {
        try {
            // Записываем в редксовский слайс код из шаблона с помощью reduxSliceTemplate
    ...
    // Наполняем кодом слай схему для слайса
